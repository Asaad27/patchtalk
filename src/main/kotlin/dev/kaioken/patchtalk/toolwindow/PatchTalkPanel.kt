...
import dev.kaioken.patchtalk.comments.resolveProjectFile
...
class PatchTalkPanel(
    private val project: Project,
) : JPanel(BorderLayout()), Disposable, PatchTalkCommentListener {
    private val splitLayout = patchTalkSplitLayout()
    ...
    private fun renderSelectedThread() {
        ...
        detailsPane.text = PatchTalkThreadPresentation.detailHtml(thread)
    ...
    private inner class ThreadCardRenderer : javax.swing.ListCellRenderer<CommentThread> {
        override fun getListCellRendererComponent(
            ...
            val presentation = PatchTalkThreadPresentation.listItem(value)
